...
function SheepMonitor:CreateInterfaceOptions()
	...
	local audibleBreakDesc = frame:CreateFontString(nil, 'ARTWORK', 'GameFontHighlightSmall')
	...
	local audibleBreakWarningDesc = frame:CreateFontString(nil, 'ARTWORK', 'GameFontHighlightSmall')
