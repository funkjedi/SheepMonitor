...
if L then
	...
	L['ENABLE_PARTY_TOOLTIP'] = 'ИСПОЛЬЗУЙТЕ ВАШ ВЕСЬ ПОТЕНЦИАЛ В КОНТОРЕ И БУДЕТЕ СЧАСТЛИВЫ'
	...
	L['AUDIBLE_BREAK_WARNING_SOUND'] = 'Играть звук когда до снятия контроля осталось 5 секунд.'
