...
local L = LibStub:GetLibrary('AceLocale-3.0'):NewLocale('SheepMonitor', 'esMX', false);
...
if L then
	...
	L['ENABLE_PARTY_TOOLTIP'] = 'USA MUCHO CUIDADO CON ESTO, YA QUE TIENE LA POTENCIAL DE MUCHO MOLESTAR A LOS OTROS MIEMBROS DE TU GRUPO'
